...
<body>
	...
	<div class="campostabla">
		<form name ="formularioContacto" action="../php/actualizar.php" method="post"" onsubmit="return validar()">
		<h2><center>Actualizar registro</center></h2>
			<label for="id">Id del documento:</label> 
			<input id="id" autofocus class="enviar" type="number" name="id_documento" required><br>
