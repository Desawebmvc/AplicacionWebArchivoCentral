...
<body>
	...
	<div id="div_uno">
		<center>
			<form name ="formularioContacto" action="../php/borrar_archivos.php" method="post" onsubmit="return validar()">
				<h2><center>Oprima el botón seleccionar para borrar un archivo</center></h2>
				<div class="custom-input-file">
						<input id="seleccionar" type="file" size="1" class="input-file" name="archivo" required/>
						<label for="seleccionar">Seleccionar</label>	
				</div>
				<input id="file_submit" type="submit" value="Borrar archivo" />
			</form>
		</center>
	</div>
