...
<body>
	...
	<div id="div_uno">
		<center>
			<form name ="formularioContacto" id="buscador" enctype="multipart/form-data" action="../php/descarga.php" method="GET" onsubmit="return validar()">
				<h2><center>Oprima el botón seleccionar para descargar un documento</center></h2>
				<div class="custom-input-file">
						<input id="seleccionar" type="file" size="1" class="input-file" name="archivo" />
						<label for="seleccionar">Seleccionar</label>	
				</div>
				<input id="file_submit" type="submit" value="Descargar" />
			</form>
		</center>
	</div>
